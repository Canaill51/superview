...
| 10 | `Makefile` | Cibles de build et de qualité locales. Même portée que la CI (`./...`) et même garde-fou : `test` et `coverage` exportent `SUPERVIEW_REQUIRE_FFMPEG=1` et tournent sous `-race -count=1` (M-01). |  |
